...
public class Application1 {
    ...
    public static void main(String[] args){
        ...
        /*
            * 비교 연산자
            * 비교연산자는 피연산자 사이에서 상대적인 크기를 판단하여 참 거짓을 반환하는 연산자.
        ...
        System.out.println("bool1과 bolo2가 같은지 비교 : " + (bool1 == bool2));
        System.out.println("bool1과 bolo2가 같지 않은지 비교 : " + (bool1 != bool2));
