...
public class B_ifElse {
    public void testSimpleIfElseStatement() {
         ...
         * }
         *
         * if문은 조건식의 결과값이 true면 if {}안의 코드 실행
         * 조건식의 결과값이 false면 else {}안의 코드 실행
         *
         * 조건을 만족하는지 여부에 따라 둘 중 하나는 무조건 실행해야 하는 경우 사용
         * */
...
//        숫자 하나 입력 -> Scanner, nextInt()
        Scanner sc = new Scanner(System.in);
        System.out.print("숫자를 하나 입력하세요 : ");
        int num = sc.nextInt();

//        양수면 -> if
//        조건문이 true면 "입력하신 숫자는 양수입니다." 출력
//        조건문이 false면 "입력하신 숫자는 음수입니다." 출력
//        0이면 "0입니다" 라고 출력 -> 조건문
