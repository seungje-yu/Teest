...
//        int 1age = 20;   // 숫자로 시작해서 에러발생
        int _age = 20;  // 언더스코어는 사용 가능하다 처음도가능하고 중간이나 끝에도 가능하다.
        int $harp = 20;  // $도 사용 가능하다. 처음도가능하고 중간이나 끝에도 가능하다.

        // 암묵적 약속
        int abcdefghialabcdefghialabcdefghialabcdefghialabcdefghialabcdefghialabcdefghial;

        // 합성어 일경우 첫단어는소문자, 두번째 시작 단어는 대문자로시작
        int maxAge = 20;
        int minAge = 10;
