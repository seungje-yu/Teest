...
//        선언은 stack에 배열의 주소를 보관할 수 있는 공간을 만드는 것이다.
        ...
        * 발생한 주소를 레퍼런스 변수(참조형 변수)에 저장하고 이것을 참조하여 사용하기 때문에 참조자료형(reference type)라고 한다.
        * */
        ...
        * */
        ...
        System.out.println("iarr = " + iarr); // 16진수 주솟값 출력
        System.out.println("carr = " + carr);

        /*
        * hashCode() : 일반적으로 객체의 주솟값을 10진수로 변환하여 생성된 객체의 고유한 정수값을 반환한다.
        * 동일한 객체인지 비교할 때 사용하며 동등 객체를 동일 객체로 취급하기 위한 용도로 overriding해서 사용한다.
        *
        * 동일 객체 : 값도 같고 주소값도 같은 경우
        * 동등 객체 : 값은 같고 주소값이 다른 경우
        * */
        ...
        System.out.println("수정된 darr.hashCode() = " + darr.hashCode());
        System.out.println("수정된 darr.length = " + darr.length);
