...
public class Application3 {
    public static void main(String[] args) {
        ...
        * java.unil.rdandom 클래스 nextInt() 메소드를 이용해 난수 발생
        ...
        * */
        ...
        /*3. 20부터 45까지의 난수 발생 */
        int randomNumber3 = random.nextInt(26) + 20; //45-20+1 = 26
        System.out.println("randomNumber3 = " + randomNumber3);

        /*4. -128부터 127까지의 난수 발생 */
        int randomNumber4 = random.nextInt(256) + 128;
//        int randomNumber4 = new Random().nextInt(256) - 128; // 단발성으로 (재사용안할때)
