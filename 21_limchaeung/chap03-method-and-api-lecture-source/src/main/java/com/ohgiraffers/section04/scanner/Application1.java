...
System.out.println();
         ...
         * int 범위를 초과한 값을 입력받게 되면 역시나 InputMismatchException 이 발생한다.
         * */
        ...
        * */
        sc.nextLine();  // 이건 예외케이스에 들어가는건데 뒤에서 다시 다룰 예정
