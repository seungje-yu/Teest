...
public class B_ifElse {
    ...
    public void testSimpleIfElseStatement(){
         ...
         * 조건식의 겨로가값이 거짓(false)이면 else{}안에 코드를 실행한다.
         *
         ...
         * 단, 조건과 상관없이 프로그램이 종료될 때 "프로그램을 종료합니다." 라고 출력되도록한다.
         * */
    ...
    public void testNestedIfElseStatement(){
        ...
        * 단, 0이면 "0입니다"라고 출력하세요.
        * 조건관 상관없이 프로그램이 종료될 때 "프로그램을 종료합니다." 라고 출력한다.
        * */
        ...
        if (num >= 0){
            ...
            System.out.println("음력하신 숫자는 음수입니다.");
        }
        ...
        //조건관 상관없이 프로그램이 종료될 때 "프로그램을 종료합니다." 라고 출력
