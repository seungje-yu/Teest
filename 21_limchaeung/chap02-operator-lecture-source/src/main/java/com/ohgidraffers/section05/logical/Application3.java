package com.ohgidraffers.section05.logical;
...
public class Application3 {
    public static void main(String[] args) {
        ...
        * 논리식 && 논리식 : 앞의 결과가 false이면 뒤를 실행안함
        *
        * 조건식 두 개가 모두 만족행야 true를 반환하지만 앞에서 미리 false가 나오게 되면
        ...
        *
        * 조건식 둘 중 하나라도 true를 반환하면 true를 반환하기 때문에 앞에서 미리 true 가 나오게 되면
