...
public class Application1 {
    public static void main(String[] args) {
        ...
        **/
        ...
        System.out.println("inum1과 imum2가 같은지 비교: " + (inum1 == inum2));
        System.out.println("inum2와 inum2가 같지 않은지 비교: " + (inum1 != inum2));
        ...
        System.out.println("ch1와 ch2가 같지 않은지 비교: " + (ch1 != ch2));
        ...
        System.out.println("bool1와 bool2가 같지 않은지 비교: " + (bool1 != bool2));
        ...
        System.out.println("str1 과 str2가 같은지 비교: " + (str1  == str2)); //두개의 피연산자가 서로 같기를 바라면서 조건을 건다.
        System.out.println("str1 와 str2가 같지 않은지 비교: " + (str1  != str2)); //서로 같지않기를 바라면서 조건을 건다.
        /*System.out.println("str1 이 str2보다 큰지 비교 :" + (str1  > str2));
        System.out.println("str1 이 str2보다 크거나 같은지 비교 :" + (str1  >= str2));
        System.out.println("str1 이 str2보다 작은지 비교 :" + (str1  < str2));
        System.out.println("str1 이 str2보다 작거나 같은지 비교 :" + (str1  <= str2));
        */
