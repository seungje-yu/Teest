...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * 발생한 주소를 레퍼런스변수( 참조형 변수)에 저장하고 이겄을 참조하여 사용하기 때문에 참조자료형 (reference type)이라고 한다.
        * */
        // iarr = new int[];
        iarr = new int[5];
        carr = new char[10];
        ...
        *  Stack에 저장된 주소를 heap에 할당딘 배열을 찾아갈 수 있다.
        * */

        System.out.println("iarr = " + iarr); // 16진수 주소값 출력
        System.out.println("carr = " + carr);
        /*
        * hashCode() : 일반적으로 객체의 주소값을 10 진수로 변환 하여 생성한 객체의 고유한 정수값을 반환한다.
        * 동일객체인지 비교할 때 사용할 목적으로 쓰이며. 동등객체를 동일 객체로 취급하기 위한 용도로 overriding해서 사용한다.
        *
        ...
        * */
        ...
        System.out.println("iarr이 길이 : " + iarr.length);
        System.out.println("carr이 길이 : " + carr.length);
        ...
        System.out.println("dar의 길이 : " + darr.length);

        darr = new double[30];

        System.out.println("수정 후 darr의 hashCode : " + darr.hashCode());
        System.out.println("수정 후 dar의 길이 : " + darr.length);
