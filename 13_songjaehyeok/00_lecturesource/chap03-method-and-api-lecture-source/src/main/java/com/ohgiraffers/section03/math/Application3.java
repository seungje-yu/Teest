...
public class Application3 {
    ...
    public static void main(String [] args){
        ...
        * java.until.random 클래스의 nextInt() 메소드를 이용해 난수 발생
        * nextInt(int bound) : 0부터 매개변수로 전달 받은 정수범위까지의 난수를 발생시켜서 정수 형태로 변환
        * */
        ...
        * */
        ...
        int randomNumber4 = new Random().nextInt(256) - 128; //이렇게도 쓸수 있다
