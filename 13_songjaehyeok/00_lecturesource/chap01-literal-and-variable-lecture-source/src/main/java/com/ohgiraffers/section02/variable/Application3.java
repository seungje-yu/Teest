...
public class Application3 {
    ...
    public static void main(String[] args){
        ...
        * 하는 첫 단추이다
        ...
        int age = 20;
        //int age = 20; // 동일한 변수명을 가지므로 애러 발생

        //int true = 1; // 에약어 사용 불가
    ...
    //  int 1age = 20; //숫자로 시작해서 에러 발생
        int _age = 20; // 언더스코어는 사용가능하다 처음도 가능하고 중간이나 끝에도 가능하다.
        int $harp = 20; // $도 사용 가능하다. 처음도 가능하고 중간이나 끝에도 가능하다.

        // 암묵적 약속
        int abcdefghijjkadfahfiwhfoqfqfqweqweq;

        //합성어 일경우 첫단어는 소문자, 두번째 시작 단어는 대문자로 시작한다
        int maxAge = 20;
        int minAge = 10;
