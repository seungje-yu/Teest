...
public class C_doWhile {
    ...
    public void testDoWhileExample1() {
        ...
        *
        * '기준문자열'.equals() : 문자열은 == 비교가 불가능하다. 문자열이 같은지를 비교하는 기능을 String클래스에서 제공
        * 기존 문자열과 비교할 문자열의 값이 같으면 true반환, 다르면 false반환
        * */
        ...
        } while (!str.equals("exit")); //while문에 조건식이 true일때만 작동하기 때문에 논리 부정을 붙여줘야한다.
