...
public class A_if {
    ...
    public void testSimpleIfStatement() {
        ...
        * */
        ...
        /*
        *  정수 한개를 입력 받아 그 수가 짝수이면 "입력하신 숫자는 짝수입니다. " 라도 출력하고,
        *  짝수가 아니면 출력하지 않는 구문을 작성해보자
        *  단, 조건과 상관 없이 프로그램이 종료될때 "프로그램을 종료합니다. " 라고 출력되도록 한다.
        * */

        // 정수 한개를 입력 받아 ---> scanner, nextInt
        Scanner sc =new Scanner(System.in);
        System.out.print("숫자 한 개를 입력해주세요 : ");
        int num = sc.nextInt();

        // 그 수가 짝수이면 --? if (조건식)
        //"입력하신 숫자는 짝수입니다." 츨력 --> sout
        if(num % 2 ==0){
    ...
    public void testNestedIfStatement() {
        ...
        * */
        ...
        // 단, 조건과 상관 없이 프로그램이 종료될 때 "프로그램을 종료합니다." 출력한다
        System.out.println("프로그램을 종료합니다.");
