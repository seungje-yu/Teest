...
public class Application02 {
    public static void main(String[] args) {
       ...
       // int inum = lnum; //데이터 손실 가능성을 컴파일러가 알려준다.(에러남)
        ...
        double dnum=8.0;
      //  float fnum=dnum; 데이터 손실 가능성을 컴파일러가 알려줌(에러남)
        ...
        char ch='a';
        byte bnum2=(byte) ch; //자료형보다 작은 크기이니 강제형변환을 해야한다.
        short snum2=(short)ch; //같은 2byte인데 왜 강제 형변환을 해야하나면 부호비트(sign bit)로 인한 값의 범위가 다르기 때문이다.
