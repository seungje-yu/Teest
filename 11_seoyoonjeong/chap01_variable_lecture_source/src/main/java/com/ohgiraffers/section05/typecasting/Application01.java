...
public class Application01 {
    public static void main(String[] args) {
        ...
        * */
        ...
        //int result=num1+num2; 오류난다 자료형 때문에 자동으로 큰 쪽 자료형인 long으로 변경 후 계산하기 때문에 int형 변수에 값을 담을 수 없다.
        ...
        double result2=fnum+dnum;
         // float result2=fnum+dnum; 오류난다.
        System.out.println("result2 = " + result2);

        //long eight =8888888888888888L;//이것도 자동으로 형변환 된것 (int 범위 벗어나면 에러 발생)
        // 오류난다 int를 long으로 변경하는것은 불가능 long eight=(long)8888888888;
        long eight=8;
        float four=eight;
