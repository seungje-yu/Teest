...
public class Application01 {
    public static void main(String[] args) {
        ...
        * 논리 연산자의 종류
        ...
        System.out.println("flase 와 true의 논리 and 연산:"+(false && true));
        ...
        System.out.println("flase 와 true의 논리  or 연산:"+(false || true));
        ...
        System.out.println(" a가 b 보다 작으면서 c가 d 보다 작은지 확인 " +(a < b && c < d) );
        System.out.println("a가 b보다 작으면서 c가 d 보다 큰지 확인:" +(a<b && c> d));
        System.out.println("a가 b보다 크면서 c가 d 보다 작은지 확인:" + (a>b && c<d));
        System.out.println("a가 b보다 크면서 c가 d 보다 작은지 확인:" + (a>b && c>d));
