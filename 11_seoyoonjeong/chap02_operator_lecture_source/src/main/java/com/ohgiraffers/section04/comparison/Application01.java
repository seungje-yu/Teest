...
public class Application01 {
    public static void main(String[] args) {
        ...
        /*
        * 비교 연산자
        * 비교연산자는 피연사자 사이에서 상대적인 크기를 판단하여 참 혹은 거짓을 반환하는 연산자이다.
        ...
        * */
        ...
        System.out.println("dnum1과 dnum2가 같은지 비교:"+(inum1 == inum2));
        System.out.println("dnum1과 dnum가 같지 않은지 비교:"+(inum1 != inum2));
        System.out.println("dnum1이 dnum2보다 큰지 비교 " +(inum1 > inum2) );
        System.out.println("dnum1이 dnum2보다 크거나 같은지 비교 " +(inum1 >= inum2) );
        System.out.println("dnum이  dum2 보다 작은지 비교" +(inum1<inum2));
        System.out.println("dnum1이 dnum2보다 작거나 같은지 비교 " +(inum1 <= inum2) );
        ...
        System.out.println("ch1과 ch2 같지 않은지 비교:"+(ch1 != ch2));
        ...
        System.out.println("bool1과 bool2 같지 않은지 비교:"+(bool1 != bool2));
...
//        System.out.println("bool1이 bool2보다 작거나 같은지 비교 " +(bool1 <= bool2) );
        ...
        System.out.println("str1과 str2 같지 않은지 비교:"+(str1 != str2));
//        System.out.println("str1이 str2보다 큰지 비교 " +(bool1 > bool2) );
//        System.out.println("str1이 str2보다 크거나 같은지 비교 " +(bool1 >= bool2) );
//        System.out.println("str1이 str2 보다 작은지 비교" +(bool1<bool2));
//        System.out.println("str1이 str2보다 작거나 같은지 비교 " +(bool1 <= bool2) );
