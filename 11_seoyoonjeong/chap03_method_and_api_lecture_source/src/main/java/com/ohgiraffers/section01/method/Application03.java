...
public class Application03 {
    public static void main(String[] args) {
        ...
        *
        ...
        이 때 전달하는 값을 전달인자(argument)라고 부르고, 메소드 선언부 괄호 안에 전달 인자를 받기 위해 선언하는 변수를 매개 변수(parameter)라고 부른다.

         */
        Application03 app3=new Application03();
        app3.testMethod(40);
        //app3.testMethod(20,30,40); //매개변수는 int형 1개이지만 전달인자는 3개이기 때문에 호출 불가능
