...
public class Application2 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*
        * 선언한 레퍼런스 변수에 배열을 할당하여 대입할 수있다.
        * new 연산자는 heap영역에 공간을 할당하고 발생한 주소값을 반환하는 연산자이다.
        * 발생한 주소를 레퍼런스변수(참조형 변수)에 저장하고 이것을 참조하여 사용학 때문에 참조자료형(reference type)이라고 한다.
        * */
    //    iarr = new int[]; // 크기를 지정해 주지않아서 에러 발생
        iarr = new int[5];
        carr = new char[10];
        ...
        * 동일객체인지 비교할 때 사용할 목적으로 쓰여지며, 동등객체를 동일객체로 취급하기 위한 용도로 overrding해서 사용한다.
        *
        ...
        * */
        ...
        System.out.print("새로 할당할배열이 길이를 입력하세요 : ");
        int size = sc.nextInt();
        ...
        darr = null; //nullPointException주의..
//        System.out.println("삭제 후 darr의 길이 : " + darr.length);//NullPointException발생
    }
}
