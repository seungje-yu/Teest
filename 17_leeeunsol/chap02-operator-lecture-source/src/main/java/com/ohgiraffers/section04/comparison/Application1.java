...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * 연산자 중 참 혹은 겆시을 반환하는 연산자는 삼항연산자의 조건식이나 조거눔ㄴ의 조건절에 많이 사용된다.
        * */
        /*
         *  비교연산자의 종류
        ...
        System.out.println("dnum1과 dnum2가 같은지 않은지 비교 : " + (dnum1 != dnum2));
...
//        System.out.println("bool1이 bool2보다 작은거나 같은지 비교 : " + (bool1 <= bool2)); //오류발생
//        System.out.println("bool1이 bool2보다 큰지 비교 : " + (bool1 > bool2)); //오류발생
//        System.out.println("bool1이 bool2보다 크거나 같은지 비교 : " + (bool1 >= bool2)); //오류발생
//        System.out.println("bool1이 bool2보다 작은지 비교 : " + (bool1 < bool2)); //오류발생
//        System.out.println("bool1이 bool2보다 작은거나 같은지 비교 : " + (bool1 <= bool2)); //오류발생
