...
public class Application3 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /*
        * 논리식 && 논리식 : 앞의 결과가 false이면 뒤를 실행안함
        *
        * 조건식 두 개가 모두 만조갷야 true를 반환하지만 아 ㅍ에서 미리 false가 나오게되면
        * 두이ㅢ 조건을 확인할 필요없이 false를 반환한다.
        * 따라서 연산횟수를 줄이기 위해서는 && 연산의 경우 앞에 false가 나올 가능성이 높은 조건을 작성하는 편이 좋다.
        * */
        ...
        *
        * 조건식 둘중 하나라도 true를 반환 하면 true를 반환하기 대문에 앞에서 미리 true가 나오게 되면
