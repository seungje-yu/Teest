...
public class Application1 {
    /**
     * 변수의 사용목적
     * 1. 값에 의미를 부여하기 위한 목적(의미 전달이쉬워야 코드를 읽기 쉬워지고, 협업 및 유지보수에 유리하기 때문이다.) - 변수명을 어떤 값을 넣었는지 유추가능하게 작성한다면 이후 코드를 해석하는데 편함(명사로)
     * 2. 한 번에 저장해둔 값을 재 사용하기 위한 목적(변수를 이용하여 코드를 작성하면, 값을 변경할 대도 보다 간편하게 변경할 수 있다.)
     * 3. 시간에 따라 변하는 값을 저장하고 사용할수 있다. (변하는 값을 저장하기 위한 공간이다.) -반대 의미 변하지않는 값을 저장하는것을 "상수"라고함
     */
