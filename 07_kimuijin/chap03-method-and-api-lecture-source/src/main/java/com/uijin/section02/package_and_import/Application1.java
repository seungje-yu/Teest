...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        com.uijin.section01.method.Calculator calc = new com.uijin.section01.method.Calculator();
        int min = calc.minNumberOf(30, 20);

        System.out.println("30과 20중 더 작은 값은 : " + min);

        /* 2. static  메소드의 경우 */
        int max = com.uijin.section01.method.Calculator.maxNumberOf(30, 20);
        System.out.println("30과 20중 더 작은 값은 : " + max);
