package com.uijin.section04.comparison;
...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /*
         * 비교 연산자
         * 비교 연산자는 피연산자 사이에서 크기를 판단하여 참 혹은 거짓을 반환하는 연산자이다.
        ...
        System.out.println("inum1과 inum2가 같지 않은지 비교 : " + (inum1 != inum2));       // 달라서 true
        ...
        System.out.println("dnum1과 dnum2가 같지 않은지 비교 : " + (dnum1 != dnum2));       // 달라서 true
        ...
        System.out.println("===============문자값 비교===============");     // 문자도 비교 연산자 사용 가능하다.
        System.out.println("ch1과 ch2가 같은지 비교 : " + (ch1 == ch2));
        System.out.println("ch1과 ch2가 같지 않은지 비교 : " + (ch1 != ch2));       // 달라서 true
        ...
        // 논리값 비교는 ==와 !=은 비교 가능하지만 대소비교는 불가능하다.
        boolean bool1 = true;
        boolean bool2 = false;

        System.out.println("===============논리값 비교===============");
        System.out.println("bool1과 bool2가 같은지 비교 : " + (bool1 == bool2));
        System.out.println("bool1과 bool2가 같지 않은지 비교 : " + (bool1 != bool2));       // 달라서 true
...
//        System.out.println("bool1이 bool2보다 작거나 같은지 비교 : " + (bool1 <= bool2));
        ...
        // 문자열 값 비교도 ==와 !=은 비교가능하지만 대소비교는 불가능하다.
        String str1 = "java";
        String str2 = "java";       // 딱 이경우에만 비교 가능  ?

        System.out.println("===============문자열값 비교===============");
        System.out.println("str1과 str2가 같은지 비교 : " + (str1 == str2));
        System.out.println("str1과 str2가 같지 않은지 비교 : " + (str1 != str2));       // 달라서 true
//        System.out.println("str1이 str2보다 큰지 비교 : " + (str1 > inum2));
//        System.out.println("str1이 str2보다 크거나 같은지 비교 : " + (str1 >= str2));
//        System.out.println("str1이 str2보다 작은지 비교 : " + (str1 < inum2));
//        System.out.println("str1이 str2보다 작거나 같은지 비교 : " + (str1 <= str2));
        ...
        boolean result = x <= y;        // 이렇게도 가능하다 - 수행결과 불린 값
