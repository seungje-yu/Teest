...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        byte bnum = 1;
        short snum = bnum;      // bnum이 snum으로 자동 형변환. 빨간줄 안 떴따는 건 형변환이 됐다는 것
        int inum = snum;        // inum으로 자동 형변환
        long lnum = inum;
...
//        int result = num1 + num2;       // 자동으로 큰 쪽 자료형인 long으로 변경 후 계산하기 때문에 int형 변수에 값을 담을 수 없다.
        long result1 = num1 + num2;     // 에러 안 났으니 형변환 된 것.
...
//        long eight = 8888888888888888888L;
//        long eight = 888888888;     // 이것도 자동으로 형변환 된 것 (int 범위 벗어나면 에러 발생)
        long eight = 8;
        float four = eight;
