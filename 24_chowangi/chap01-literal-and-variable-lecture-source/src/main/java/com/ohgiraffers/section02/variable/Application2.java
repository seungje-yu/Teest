...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        snum = 2;
        inum = 4;
//        lnum = 8;     // 아무 문제 없는 것 같지만 뒤에 대문자 L을 붙여야한다.

        lnum = 8L;      // 소문자로 써도 되지만 1과 혼선이 빚어질 수 있어서

//        fnum = 4.0;   // 실수 형태의 값을 float에 사용하는 것은 불가능하다.
        fnum = 4.0f;    // 소문자 f 를 사용하는게 일반적이다.
        dnum = 8.0;
        ...
        point = point + 100;
        System.out.println("ponit = point + 100 ? " + point);
