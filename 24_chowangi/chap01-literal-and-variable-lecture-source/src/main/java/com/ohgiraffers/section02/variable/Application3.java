...
public class Application3 {
    ...
    public static void main(String[] args) {
        ...
        * 실무적으로는 굉장히 중요, 또한 규칙에 맞는 올바른 변수명을 짓는 것이 좋은 프로그래밍을 위한 첫 단추
         */
...
//        int true = 1; // 변수명은 예약어로는 사용 불가
//        int for = 20; // 변수명은 예약어로는 사용 불가
...
//        int 1age = 20;    // 숫자로 시작해서 에러발생
        int _age = 20;  // 언더스코어는 어디든 사용 가능하다.
        int $harp = 20; // $도 사용 가능하다.

        // 암묵적 약속
        int abcdefgabcdefgabcdefgabcdefgabcdefgabcdefgabcdefgabcdefg;

        // 합성어일 경우 첫 단어는 소문자, 두 번째 시작 단어는 대문자로 시작
        int maxAge = 20;
        int minAge = 10;

//        String user_name; // 암묵적 약속
        String userName;

        int 나이; // 권장하지는 않음

        String s;       // 변수가 어떤 의미인지 파악하기 힘듬
        String name;    // 문자열 형태의 이름이 저장되겠구나 하고 의미가 파악이 됨
