...
public class Application1 {
     ...
     * 2. 한 번 저장해둔 값을 재사용하기 위한 목적(변수를 이용하여 코드를 작성하면, 값을 변경할 때도 보다 간편하게 변경할 수 있음)
     * 3. 시간에 따라 변하는 값을 저장하고 사용할 수 있다(변하는 값을 저장하기 위한 공간임)
     * */
    public static void main(String[] arg){
        ...
        sum = sum + 10;
        System.out.println("sum에 10이 있었으니 10을 추가로 더하면 현재 sum의 값은? " + sum);

        sum = sum + 10;
        System.out.println("sum에 20이 있었으니 10을 추가로 더하면 현재 sum의 값은? " + sum);
