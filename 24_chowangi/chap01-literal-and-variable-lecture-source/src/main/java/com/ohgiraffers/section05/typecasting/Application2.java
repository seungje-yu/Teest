...
//        long lnum2 = fnum2; // 소수점 자리 이하 데이터 손실 가능성
        long lnum2 = (long) fnum2;  // 강제 형변환의 의미는 '내가 데이터 손실을 감수할테니 형변환 해줘'의 의미

        // 문자형을 int미만 크기의 변수에 저장할 때 강제 형변환이 필요하다.
        char ch = 'a';
        byte bnum2 = (byte) ch; // char 자료형보다 작은 크기이니 강제 형변환을 해야한다.
        short snum2 = (short) ch;   // 같은 2byte인데 왜 강제 형변환을 해야하냐면, 부호비트(sign)로 인한 값의 범위가 다르기 때문이다.
