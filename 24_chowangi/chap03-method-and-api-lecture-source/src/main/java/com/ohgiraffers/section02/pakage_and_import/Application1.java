...
public class Application1 {
    ...
    public static void main(String[] arg){
        ...
        com.ohgiraffers.section01.method.Carculator calc = new com.ohgiraffers.section01.method.Carculator();
        int min = calc.minNumberOf(30, 20);

        System.out.println("30과 20 중 더 작은 값은 : " + min);

        /* 2. static 메소드의 경우 */
        int max = com.ohgiraffers.section01.method.Carculator.maxNumberOf(30, 20);
