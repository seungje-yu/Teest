...
public class Application7 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("두 수를 더한 결과 : " + app7.plusTwoNeumbers(first, second));
        System.out.println("두 수를 뺀 결과 : " + app7.minusTwoNumbers(first, second));
        System.out.println("두 수를 곱한 결과 : " + app7.minusTwoNumbers(first, second));
        System.out.println("두 수를 나눈 결과 : " + app7.divideTwoNumbers(first, second));

    }

    public int plusTwoNeumbers(int first, int second){
