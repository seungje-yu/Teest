...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*
        비교 연산자
        - 비교 연산자는 피연산자 사이에서 상대적인 크기를 판단하여 참 혹은 거짓을 반환하는 연산자
...
//        System.out.println(("bool1이 bool2보다 작거나 같은지 비교 : " + (bool1 <= bool2)));
 ...
 //        System.out.println(("strl1이 strl2보다 큰지 비교 : " + (str1 > str2)));
 //        System.out.println(("strl1이 strl2보다 크거나 같은지 비교 : " + (str1 >= str2)));
 //        System.out.println(("strl1이 strl2보다 작은지 비교 : " + (str1 < str2)));
 //        System.out.println(("strl1이 strl2보다 작거나 같은지 비교 : " + (str1 <= str2)));
