...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * 발생한 주소를 레퍼런스변수(참조형 변수)에 저장하고 이것을 참조하여 사용하기 때문에 참조자료형(reference type)
        * */
//        iarr = new int[]; // 크기를 지정해주지 않아서 에러 발생
        ...
        *  stack에 저장된 주소를 heap에 해당된 배열을 찾아갈 수 있다.
        *  */
        System.out.println("iarr = " + iarr); // 16진수 주소값 출력
        System.out.println("carr = " + carr);

        /*
        * hashCode90 : 일반적으로 객체의 주소값을 10진수로 변환하여 생성한 객체의 고유한 정수값을 반환
        * 동일객체인지 비교할 때 사용할 목적으로 쓰여지며, 동등객체를 동일객체로 취급하기 위한 용도로 overriding해서 사용
        *
