...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(1.23 / 10.0);
        System.out.println(1.23 % 3.0); // 약간의 오차 발생
        ...
        System.out.println('a' % 2.0);
        // 결론은 문자는 내부적으로 숫자 취급
        // 지금까지 숫자끼리의 연산을 본것이고, 숫(정수 혹은 실수) 형태의 값은 수학의 사칙연과 mod연산이 전부가능하다.

        // 문자열의 연산
        // 문자열과 문자열의 '+'연산 결과는 문자열 합치기(이어 붙이기)만 됨.
...
//        System.out.println("hello" % "world");
        ...
        //숫자로 된 문자열 형태의 값은 '+' 연사의 결과가 문자열 합치기가 됨
        ...
        // 문자는 내부적으로 숫자 취급을 하기 때문에 결국 논리값과 숫자의 연산과 동일
        //System.out.println(true + 'a'); // 에러
