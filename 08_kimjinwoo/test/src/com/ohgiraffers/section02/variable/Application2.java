...
public class Application2 {
    public static void main(String[] args) {
        ...
        /* 자료형이란?
         ...
         - ex) 앞에서 사용한 int 자료형은 정수를 4byte만큼을 읽어서 하나의 값으로 취급하겠다는 약속이다.
               이러한 자료형은 기본자료형(Primary type)과 참조자료형(Reference type)으로 나누어진다.
         */

        //기본 자료형 8가지 부터 시작
        //정수를 취급하는 자료형 4가지(선언만 했다.)
        byte bnum;
        short snum;
        int inum;
        long lnum;

        //실수를 취급하는 자료형 2가지(선언만 했다.)
        float fnum;
        double dnum;
        ...
        //논리값을 취급하는 자료형(선언만 했다.)
        boolean isTrue;

        //이상 8가지를 기본자료형(Primary type)

        String str; //참조자료형 4byte(주소값은 4byte정수형)
        ...
        lnum = 8L;  // 소문자로 'l'을 써도 되지만 글꼴에 따라
                    // 숫자 1과 혼선이 빚어질 수 있어서 대문자로 하는것이 권장이다.
        //fnum = 4.0; // 실수형태의 값을 fnum에 사용하는 것은 불가능하다.
        fnum = 4.0f;  //실수 뒤에 'f'를 붙여여한다. 'F'도 가능하지만 소문자를 사용하는 것이 일반적이다.
        dnum = 8.0;
