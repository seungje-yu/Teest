...
public class Application3 {
    public static void main(String[] args) {
        ...
        /* 변수의 명명 규칙
           ...
           실무적으로는 굉장히 중요하기 때문에 반드시 숙지해야 하고, 또한 규칙에 맞는 올바른 변수명을 짓는 것이 좋은 프로그래밍을
           하는 첫 단추이다.
         */
         ...
         *    2-9 scope는 {}와 같은말이다. 즉 같은 공간안에라는 말과 같은말이다.
         * */
        ...
        int _age = 20; //'_'(언더스코어)는 사용 가능하다. 처음도 가능하고 중간이나 끝에도 가능하다.
        int $harp = 20; //$도 사용 가능하다. 처음도 가능하고 중간이나 끝에도 가능하다.

        //암묵적 약속
        int abcdefghijkabcdefghijkabcdefghijkabcdefghijkabcdefghijkabcdefghijk;

        //합성어일 경우 첫 단어는 소문자, 두 번째 시작 단어는 대문자로 시작
        int maxAge = 20;
        int minAge = 10;

        String user_name; //이것 보다는
        String userName; //이것이 낫다.

        int 나이; // 권장하지는 않는다.

        String s; // 변수가 어떤 의미인지 파악하기 힘들다.
        String name; //문자열 형태의 이름이 저장되겠구나하고 의미가 파악이된다.
