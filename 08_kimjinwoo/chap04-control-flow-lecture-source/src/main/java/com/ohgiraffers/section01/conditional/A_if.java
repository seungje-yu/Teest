...
public class A_if {
    ...
    public void testSimpleIfStatement() {
        ...
        // 1. 정수 한 개를 입력 받아 --> scanner, nextInt()
        Scanner sc = new Scanner(System.in);
        System.out.print("숫자 한 개를 입력하세요 : ");
        int num = sc.nextInt();

        // 2. 그 수가 짝수이면 --> if(조건식)이 참이면,
        // 3. "입력하신 숫자는 짝수입니다." 출력 --> sout
        if(num % 2 == 0) {
    ...
    public void testNestedIfStatement() {
        ...
        */
        ...
        if(num > 0) {
            // 짝수이면 "입력하신 숫자는 양수이면서 짝수입니다." 출력 --> if
            if(num % 2 == 0) {
    ...
    public void test() throws IOException {
        ...
        System.out.print("작성 ㄱㄱ : ");
        int num = Integer.parseInt(br.readLine());

        if(num % 2 == 0) {
            System.out.println("짝수임요~");
        }
