...
public class B_ifElse {
    ...
    public void testSimpleIfElseStatement() {
        ...
        if(num % 2 != 0) { // 홀수를 입력할건데 죽어도 0을 쓰고 싶다! (!= 0)을 하면 된다.
        ...
        // 단. 조건과 상관없이 프로그램 종료될 때 "프로그램을 종료합니다." 라고 출력
    ...
    public void testNestedIfElseStatement() {
        ...
        // 조건과 상관없이 프로그램이 종료될 때 "프로그램을 종료합니다." 라고 출력
