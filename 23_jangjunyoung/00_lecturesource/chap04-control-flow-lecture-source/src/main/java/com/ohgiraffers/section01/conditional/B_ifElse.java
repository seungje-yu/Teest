...
public class B_ifElse {
    ...
    public void testSimpleIfElseStatement() {
        ...
        // 그 수가 홀수 이면 --> 조건절 (if)
        if ( num % 2 == 1 ) {
            // 조건절이 참이면 "입력하신 숫자는 홀수입니다."라고 출력 --> print
            System.out.println("입력하신 숫자는 홀수입니다.");
            // 조건절이 거짓이면 --> else
        } else {
            // 조건절이 거짓이면 "입력하신 숫자는 짝수입니다."라고 출력 --> print
            System.out.println("입력하신 숫자는 짝수입니다.");
        }
        // 단, 조건과 상관 없이 프로그램이 종료될 때 "프로그램을 종료합니다."라고 출력 --> print
    ...
    public void testNestedIfElseStatement() {
        ...
        // 양수이면 --> 조건문
        // 조건문이 true일 경우, "입력하신 숫자는 양수입니다." 출력 --> print

        // 음수이면 --> 조건문
        // 조건문이 false일 경우, "입력하신 숫자는 음수입니다." 출력 --> print

        // 단, 입력받은 숫자가 0이면 --> 조건문
        // 조건문이 true일 경우, "0입니다." 출력 --> print

        // 조건과 상관 없이 프로그램이 종료될 때 "프로그램을 종료합니다." 라고 출력 --> print
