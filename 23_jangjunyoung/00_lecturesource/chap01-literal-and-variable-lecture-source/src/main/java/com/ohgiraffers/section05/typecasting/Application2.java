...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        long lunm2 = (long) fnum2; // 강제 형변환의 의미는 '내가 데이터 손실을 감안할테니 형변환 해줘'라는 의미

        // 문자형을 int 미만 크기의 변수에 저장할 때 강제 형변환이 필요하다.
        char ch = 'a'; // char = 2byte > byte = 1byte
        byte bnum2 = (byte) ch; // char 자료형 보다 byte 자료형이 더 작은 크기를 가지고 있으니 강제 형변환을 해야 한다.
        short snum2 = (short) ch; // 같은 2byte인데 왜 강제 형변환을 해야 하나면 부호비트(sign bit)로 인한 값의 범위가 다르기 때문이다.
