...
public class B_while {
    ...
    * */
    ...
    public void testSimpleWhileStatement(){
        /*1부터 10까지 1씩 증가 (10번) i 값을 출력하는 기본 반복문*/
        int i =1;
        int sum=0;
        while(i<=10) {
            sum =0;
    ...
    public void testWhileExample1(){
        ...
        /*아래의 두개의 메소드는 전부 String 클래스에서 제공하는 메소드
        charAt() : 문자열에서 인덱스에 해당하는 문자를 char형으로 반환하는 기능
        * length() : String클래스의 메소드로 문자열의 길이를 int 형으로 반환하는 기능
        index는 0부터 시작하고 마지막 인덱스는 항상 길이보다 한 개 작은 숫자를 가짐
        만약 존재하지 않는 인덱스에 접근하게 되면 StringIndexOutOfBoundsException 발생*/
