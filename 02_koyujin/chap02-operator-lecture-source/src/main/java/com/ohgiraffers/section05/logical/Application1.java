...
public class Application1 {
     ...
     */
        ...
        System.out.println("true와 false의 논리 and 연산: " + (false && true)); //false
        System.out.println("false와 false의 논리 and 연산: " + (false && false)); //false

        System.out.println("true와 true의 논리 or 연산: " + (true || true)); //true
        System.out.println("true와 false의 논리 or연산: " + (true || false)); //true
        System.out.println("true와 false의 논리 or연산: " + (false || true)); //true
        ...
        System.out.println("a가 b보다 크면서 c가 d보다 작은 지 확인: " + (a > b && c < d)); //false
        System.out.println("a가 b보다 크면서 c가 d보다 큰 지 확인: " + (a > b && c > d)); //false


        System.out.println("a가 b보다 작거나 c가 d보다 작은지 확인: " + (a < b || c < d)); //true
        System.out.println("a가 b보다 작거나 c가 d보다 큰지 확인: " + (a < b || c > d)); //true
        System.out.println("a가 b보다 크거나 c가 d보다 작은 지 확인: " + (a > b || c < d)); //true
        System.out.println("a가 b보다 크거나 c가 d보다 큰 지 확인: " + (a > b || c > d)); //false
    }
}
