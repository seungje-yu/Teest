...
public class Application1 {
    public static void main(String[] args) {
        ...
        * (비교/ 논리연산자가 주로 사용됨)*/
        ...
        System.out.println("num1 = " + result1); //양수다
        System.out.println("num2 = " + result2); //양수가 아니다
        /*삼항연산자 중첩 사용*/
        int num3 = 5;
        int num4 = 0;
        int num5 = -5;
        ...
        String result4 = (num4 > 0) ? "양수다": (num3 == 0) ? "0이다" : "음수이다";
        String result5 = (num5 > 0) ? "양수다": (num3 == 0) ? "0이다" : "음수이다";
