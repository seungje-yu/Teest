...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /*
        1부터 100 사이의 값인지 확인하고 싶음.
        - 1 <= 숫자 <= 100 <<< 이렇게는 사용 불가능, 변수가 1보타 크거나 and 변수가 100보다 작을 때
         */

        int num1 = 55;
        System.out.println(num1 + "가 1부터 100사이인지 확인 : " + (num1 >= 1 && num1 <= 100));
        ...
        char ch3 = 'Y';
        System.out.println("영문자 y인지 학인 : " + (ch3 == 'y' || ch3 == 'Y'));

        char ch4 = 'y';
        System.out.println("영문자 y인지 학인 : " + (ch4 == 'y' || ch4 == 'Y'));
