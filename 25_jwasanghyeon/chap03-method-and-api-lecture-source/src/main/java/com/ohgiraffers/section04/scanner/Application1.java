...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            int 범위를 초과한 값을 입력받게 되면 위 에러 발생
         */
        ...
        /*
            ...
            만약 존재하지 않는 인덱스를 입력하게 되면 IndexOutOfBoundsExc이 발생한다.
         */

        sc.nextLine();  // 이건 예외 케이스에 들어가는건데 뒤에서 다시 다룰 예정
        System.out.print("아무 문자나 입력해주세요 : ");
        char ch = sc.nextLine().charAt(0);    // 문자열을 입력받고 거기서 뽑아 쓴다.
