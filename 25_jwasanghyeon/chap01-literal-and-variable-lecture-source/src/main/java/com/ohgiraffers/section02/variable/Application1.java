...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        sum = sum + 10; // 대입연산자 (=) 기준으로 왼쪽은 공간, 오른쪽은 값
        System.out.println("sum에 10을 더하면 현 재 sum 값은? : " + sum);

        sum = sum + 10;
        System.out.println("sum에 10이 있었으니 10을 또 더하면 현 재 sum 값은? : " + sum);

        sum = sum + 10;
        System.out.println("sum에 20이 있었으니 10을 또 더하면 현 재 sum 값은? : " + sum);
