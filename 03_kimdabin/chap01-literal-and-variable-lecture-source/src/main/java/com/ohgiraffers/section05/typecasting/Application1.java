...
//        int rsult = num1 + num2; //자동으로 큰 자료형인 long 으로 변경 후 계산하기 때문에 int형 변수에 값을 담을 수 없다. ㄴ
//        int rsult = num1 + (int) num2;
//        long rsult = num1 + num2;
...
//        long eight = 8888888888888888888; //에러
//        long eight = 8888888888888888888L; //long 으로 인식시키게 함
        long eight = 8;
        float four = eight;
