...
public class Application2 {
    public static void main(String[] args) {
        ...
        /*
         * 임포트란?
         * 서로 다른 패키지에 존재하는 클래스를 사용하는 경우 패키지명을 포함한 풀 클래스 이름을사용해야 한다.
         * 하지만 매번 다른 클래스의 패키지명까지 기술하기 번거롭다.
         * 그래서 패키지명을 생력하고 사용할 수 있도록 한 구문이 import 구문아디.
         * import 는 package선언문과 class 선언문 사이에 작성하며
         * 어떠한 패키지 내에 있는 클래스를 사용할 것인지에 대해 미리 선언하는 효과를 가진다.
         *
         * 임포트를 안해도 사용할 수 있는 package 가 있다. --> java.lang 패키지
         * */
        Calculator calc = new Calculator();
        int min = calc.minNumbersOf(50, 60);
