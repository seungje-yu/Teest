...
public class B_ifElse {
    public void testSimpleOfElseStatement() {
        /*
         * [if-else문 표현식]
         * if(조건식) {
        ...
        /*
         * 정수 한 개를 입력 받아 그 수가 홀수이면
         * "입력하신 숫자는 홀수입니다." 라고 출력하고,
         * 홀수가 아니면 "입력하신 숫자는 짝수입니다." 라고 출력하는
         * 프로그램을 작성해보자. 단, 조건과 상관없이
         * 프로그램이 종료될 때 "프로그램을 종료합니다." 라고 출력되도록 한다.
         * */
