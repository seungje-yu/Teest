...
public class C_ifElseIf {
    public void testSimpleElseIfStatement(){
        /*
         *  if(조건식1) {
...
//        }
    ...
    public void testNestedIfElseIfStatement() {
        ...
        String grade = "";
        if(point >= 90){
        //    String grade = "A";  // 지역변수 if 안에서만 유효함
            grade = "A";
            if(point >= 95){
                grade += "+";
            }
