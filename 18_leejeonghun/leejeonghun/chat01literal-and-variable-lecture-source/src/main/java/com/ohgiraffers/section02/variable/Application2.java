...
public class Application2 {
    public static void main(String[] args){
         ...
         *     이러한 자료형은 기본자료형(Primary Type)과 참조가료형(Reference Type)으로 나누어진다.
         */
