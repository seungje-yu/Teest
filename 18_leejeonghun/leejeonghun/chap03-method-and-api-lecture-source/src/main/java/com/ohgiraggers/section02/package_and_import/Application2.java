package com.ohgiraggers.section02.package_and_import;

import com.ohgiraggers.section01.method.Calculator;
// import java.sql.Date;
import java.util.Date;

import static com.ohgiraggers.section01.method.Calculator.maxNumberOf; // *을 사용하면 해당 패키지에 있는 모든 클래스를 사용하겠다는 의미 ex) import com.ohgiraggers.section01.method.*;
