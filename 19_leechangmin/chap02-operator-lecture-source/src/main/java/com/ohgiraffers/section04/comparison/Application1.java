...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("srt1과 str2가 같은지 비교: " + (srt1 == srt2));
        System.out.println("srt1과 str2가 같지 않은지 비교: " + (srt1 != srt2));
//        System.out.println("srt1이 str2보다 큰지 비교: " + (srt1 > srt2));
//        System.out.println("srt1이 str2보다 크거나 같은지 비교: " + (srt1 >= srt2));
//        System.out.println("srt1이 str2보다 작은지 비교: " + (srt1 < srt2));
//        System.out.println("srt1이 str2보다 작거나 같은지 비교: " + (srt1 <= srt2));
//        bool형과 같이 같은지 같지 않은지 2가지만 비교가 가능하다.
